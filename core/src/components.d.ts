...
declare global {
  ...
  namespace StencilComponents {
    interface IonModalController {
      'create': (opts?: ModalOptions<ComponentRef> | undefined) => Promise<HTMLIonModalElement>;
...
declare global {
  ...
  namespace StencilComponents {
    interface IonNav {
      ...
      'insert': <T extends NavComponent>(insertIndex: number, component: T, componentProps?: (T extends "object" | "a" | "abbr" | "acronym" | "address" | "applet" | "area" | "article" | "aside" | "audio" | "b" | "base" | "basefont" | "bdo" | "big" | "blockquote" | "body" | "br" | "button" | "canvas" | "caption" | "center" | "cite" | "code" | "col" | "colgroup" | "data" | "datalist" | "dd" | "del" | "dfn" | "dir" | "div" | "dl" | "dt" | "em" | "embed" | "fieldset" | "figcaption" | "figure" | "font" | "footer" | "form" | "frame" | "frameset" | "h1" | "h2" | "h3" | "h4" | "h5" | "h6" | "head" | "header" | "hgroup" | "hr" | "html" | "i" | "iframe" | "img" | "input" | "ins" | "isindex" | "kbd" | "keygen" | "label" | "legend" | "li" | "link" | "listing" | "map" | "mark" | "marquee" | "menu" | "meta" | "meter" | "nav" | "nextid" | "nobr" | "noframes" | "noscript" | "ol" | "optgroup" | "option" | "output" | "p" | "param" | "picture" | "plaintext" | "pre" | "progress" | "q" | "rt" | "ruby" | "s" | "samp" | "script" | "section" | "select" | "slot" | "small" | "source" | "span" | "strike" | "strong" | "style" | "sub" | "sup" | "table" | "tbody" | "td" | "template" | "textarea" | "tfoot" | "th" | "thead" | "time" | "title" | "tr" | "track" | "tt" | "u" | "ul" | "var" | "video" | "wbr" | "xmp" | "ion-icon" | "ion-action-sheet-controller" | "ion-action-sheet" | "ion-alert-controller" | "ion-alert" | "ion-anchor" | "ion-animation-controller" | "ion-app" | "ion-avatar" | "ion-back-button" | "ion-backdrop" | "ion-badge" | "ion-button" | "ion-buttons" | "ion-card-content" | "ion-card-header" | "ion-card-subtitle" | "ion-card-title" | "ion-card" | "ion-checkbox" | "ion-chip-button" | "ion-chip" | "ion-col" | "ion-content" | "ion-datetime" | "ion-fab-button" | "ion-fab-list" | "ion-fab" | "ion-footer" | "ion-gesture-controller" | "ion-gesture" | "ion-grid" | "ion-header" | "ion-hide-when" | "ion-img" | "ion-infinite-scroll-content" | "ion-infinite-scroll" | "ion-input" | "ion-item-divider" | "ion-item-group" | "ion-item-option" | "ion-item-options" | "ion-item-sliding" | "ion-item" | "ion-label" | "ion-list-header" | "ion-list" | "ion-loading-controller" | "ion-loading" | "ion-menu-button" | "ion-menu-controller" | "ion-menu-toggle" | "ion-menu" | "ion-modal-controller" | "ion-modal" | "ion-nav-pop" | "ion-nav-push" | "ion-nav-set-root" | "ion-nav" | "ion-note" | "ion-picker-column" | "ion-picker-controller" | "ion-picker" | "ion-popover-controller" | "ion-popover" | "ion-radio-group" | "ion-radio" | "ion-range-knob" | "ion-range" | "ion-refresher-content" | "ion-refresher" | "ion-reorder-group" | "ion-reorder" | "ion-ripple-effect" | "ion-route-redirect" | "ion-route" | "ion-router-outlet" | "ion-router" | "ion-row" | "ion-scroll" | "ion-searchbar" | "ion-segment-button" | "ion-segment" | "ion-select-option" | "ion-select-popover" | "ion-select" | "ion-show-when" | "ion-skeleton-text" | "ion-slide" | "ion-slides" | "ion-spinner" | "ion-split-pane" | "ion-status-tap" | "ion-tab-button" | "ion-tab" | "ion-tabbar" | "ion-tabs" | "ion-tap-click" | "ion-text" | "ion-textarea" | "ion-thumbnail" | "ion-title" | "ion-toast-controller" | "ion-toast" | "ion-toggle" | "ion-toolbar" | "ion-virtual-scroll" ? IntrinsicElements[T] : { [key: string]: any; }) | null | undefined, opts?: NavOptions | null | undefined, done?: TransitionDoneFn | undefined) => Promise<boolean>;
      ...
      'setRouteId': (id: "object" | "a" | "abbr" | "acronym" | "address" | "applet" | "area" | "article" | "aside" | "audio" | "b" | "base" | "basefont" | "bdo" | "big" | "blockquote" | "body" | "br" | "button" | "canvas" | "caption" | "center" | "cite" | "code" | "col" | "colgroup" | "data" | "datalist" | "dd" | "del" | "dfn" | "dir" | "div" | "dl" | "dt" | "em" | "embed" | "fieldset" | "figcaption" | "figure" | "font" | "footer" | "form" | "frame" | "frameset" | "h1" | "h2" | "h3" | "h4" | "h5" | "h6" | "head" | "header" | "hgroup" | "hr" | "html" | "i" | "iframe" | "img" | "input" | "ins" | "isindex" | "kbd" | "keygen" | "label" | "legend" | "li" | "link" | "listing" | "map" | "mark" | "marquee" | "menu" | "meta" | "meter" | "nav" | "nextid" | "nobr" | "noframes" | "noscript" | "ol" | "optgroup" | "option" | "output" | "p" | "param" | "picture" | "plaintext" | "pre" | "progress" | "q" | "rt" | "ruby" | "s" | "samp" | "script" | "section" | "select" | "slot" | "small" | "source" | "span" | "strike" | "strong" | "style" | "sub" | "sup" | "table" | "tbody" | "td" | "template" | "textarea" | "tfoot" | "th" | "thead" | "time" | "title" | "tr" | "track" | "tt" | "u" | "ul" | "var" | "video" | "wbr" | "xmp" | "ion-icon" | "ion-action-sheet-controller" | "ion-action-sheet" | "ion-alert-controller" | "ion-alert" | "ion-anchor" | "ion-animation-controller" | "ion-app" | "ion-avatar" | "ion-back-button" | "ion-backdrop" | "ion-badge" | "ion-button" | "ion-buttons" | "ion-card-content" | "ion-card-header" | "ion-card-subtitle" | "ion-card-title" | "ion-card" | "ion-checkbox" | "ion-chip-button" | "ion-chip" | "ion-col" | "ion-content" | "ion-datetime" | "ion-fab-button" | "ion-fab-list" | "ion-fab" | "ion-footer" | "ion-gesture-controller" | "ion-gesture" | "ion-grid" | "ion-header" | "ion-hide-when" | "ion-img" | "ion-infinite-scroll-content" | "ion-infinite-scroll" | "ion-input" | "ion-item-divider" | "ion-item-group" | "ion-item-option" | "ion-item-options" | "ion-item-sliding" | "ion-item" | "ion-label" | "ion-list-header" | "ion-list" | "ion-loading-controller" | "ion-loading" | "ion-menu-button" | "ion-menu-controller" | "ion-menu-toggle" | "ion-menu" | "ion-modal-controller" | "ion-modal" | "ion-nav-pop" | "ion-nav-push" | "ion-nav-set-root" | "ion-nav" | "ion-note" | "ion-picker-column" | "ion-picker-controller" | "ion-picker" | "ion-popover-controller" | "ion-popover" | "ion-radio-group" | "ion-radio" | "ion-range-knob" | "ion-range" | "ion-refresher-content" | "ion-refresher" | "ion-reorder-group" | "ion-reorder" | "ion-ripple-effect" | "ion-route-redirect" | "ion-route" | "ion-router-outlet" | "ion-router" | "ion-row" | "ion-scroll" | "ion-searchbar" | "ion-segment-button" | "ion-segment" | "ion-select-option" | "ion-select-popover" | "ion-select" | "ion-show-when" | "ion-skeleton-text" | "ion-slide" | "ion-slides" | "ion-spinner" | "ion-split-pane" | "ion-status-tap" | "ion-tab-button" | "ion-tab" | "ion-tabbar" | "ion-tabs" | "ion-tap-click" | "ion-text" | "ion-textarea" | "ion-thumbnail" | "ion-title" | "ion-toast-controller" | "ion-toast" | "ion-toggle" | "ion-toolbar" | "ion-virtual-scroll", params: { [key: string]: any; }, direction: number) => Promise<RouteWrite>;
...
declare global {
  ...
  namespace StencilComponents {
    interface IonPopoverController {
      'create': <T extends ComponentRef>(opts?: PopoverOptions<T> | undefined) => Promise<HTMLIonPopoverElement>;
